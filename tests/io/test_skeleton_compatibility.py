            ...
            "links": [
                {
                    "edge_insert_idx": 0,
                    "key": 0,
                    "source": {"py/object": "sleap.skeleton.Node", "py/state": {"py/tuple": ["A", 1.0]}},
                    "target": {"py/object": "sleap.skeleton.Node", "py/state": {"py/tuple": ["B", 1.0]}},
                    "type": {"py/reduce": [{"py/type": "sleap.skeleton.EdgeType"}, {"py/tuple": [1]}]}
                },
                {
                    "edge_insert_idx": 1,
                    "key": 0,
                    "source": {"py/object": "sleap.skeleton.Node", "py/state": {"py/tuple": ["B", 1.0]}},
                    "target": {"py/object": "sleap.skeleton.Node", "py/state": {"py/tuple": ["C", 1.0]}},
