...
def cvat_tracking_dataset(tmp_path):
    ...
    annotations = {
        ...
        "images": [
            {"id": 1, "width": 100, "height": 100, "file_name": "frame01.jpg", 
             "license": 0, "flickr_url": "", "coco_url": "", "date_captured": 0},
            {"id": 2, "width": 100, "height": 100, "file_name": "frame02.jpg",
             "license": 0, "flickr_url": "", "coco_url": "", "date_captured": 0}
        ],
        "annotations": [
            # Frame 1: Two mice
    ...
    for img_info in annotations["images"]:
        ...
        img_array = np.zeros((img_info["height"], img_info["width"], 3), dtype=np.uint8)
        # We don't actually save the images since the loader will be mocked
        img_path.touch()  # Just create empty files
